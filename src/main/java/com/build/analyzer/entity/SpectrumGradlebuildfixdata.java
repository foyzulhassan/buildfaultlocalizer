...
*/
public class SpectrumGradlebuildfixdata implements java.io.Serializable {
	...
	private String spBuildCmd;
	private Integer spEVTarantulaPos;
	private Double spEVTarantulaMrr;
	private Double spEVTarantulaMap;
	private Integer spEVOchiaiPos;
	private Double spEVOchiaiMrr;
	private Double spEVOchiaiMap;
	private Integer spEVOp2Pos;
	private Double spEVOp2Mrr;
	private Double spEVOp2Map;
	private Integer spEVBarinelPos;
	private Double spEVBarinelMrr;
	private Double spEVBarinelMap;
	private Long spExecTime;
	

	public SpectrumGradlebuildfixdata() {
	}

	public SpectrumGradlebuildfixdata(long row, long f1row, long f2row, int changefileCount, int revertfileCount) {
		this.row = row;
		this.f1row = f1row;
		this.f2row = f2row;
	...
	public SpectrumGradlebuildfixdata(long row, long f1row, long f2row, String ghProjectName, String gitBranch,
	...
	public String getSpBuildCmd() {
		return spBuildCmd;
	}

	public void setSpBuildCmd(String spBuildCmd) {
		this.spBuildCmd = spBuildCmd;
	}

	public Integer getSpEVTarantulaPos() {
		return spEVTarantulaPos;
	}

	public void setSpEVTarantulaPos(Integer spEVTarantulaPos) {
		this.spEVTarantulaPos = spEVTarantulaPos;
	}

	public Double getSpEVTarantulaMrr() {
		return spEVTarantulaMrr;
	}

	public void setSpEVTarantulaMrr(Double spEVTarantulaMrr) {
		this.spEVTarantulaMrr = spEVTarantulaMrr;
	}

	public Double getSpEVTarantulaMap() {
		return spEVTarantulaMap;
	}

	public void setSpEVTarantulaMap(Double spEVTarantulaMap) {
		this.spEVTarantulaMap = spEVTarantulaMap;
	}

	public Integer getSpEVOchiaiPos() {
		return spEVOchiaiPos;
	}

	public void setSpEVOchiaiPos(Integer spEVOchiaiPos) {
		this.spEVOchiaiPos = spEVOchiaiPos;
	}

	public Double getSpEVOchiaiMrr() {
		return spEVOchiaiMrr;
	}

	public void setSpEVOchiaiMrr(Double spEVOchiaiMrr) {
		this.spEVOchiaiMrr = spEVOchiaiMrr;
	}

	public Double getSpEVOchiaiMap() {
		return spEVOchiaiMap;
	}

	public void setSpEVOchiaiMap(Double spEVOchiaiMap) {
		this.spEVOchiaiMap = spEVOchiaiMap;
	}

	public Integer getSpEVOp2Pos() {
		return spEVOp2Pos;
	}

	public void setSpEVOp2Pos(Integer spEVOp2Pos) {
		this.spEVOp2Pos = spEVOp2Pos;
	}

	public Double getSpEVOp2Mrr() {
		return spEVOp2Mrr;
	}

	public void setSpEVOp2Mrr(Double spEVOp2Mrr) {
		this.spEVOp2Mrr = spEVOp2Mrr;
	}

	public Double getSpEVOp2Map() {
		return spEVOp2Map;
	}

	public void setSpEVOp2Map(Double spEVOp2Map) {
		this.spEVOp2Map = spEVOp2Map;
	}

	public Integer getSpEVBarinelPos() {
		return spEVBarinelPos;
	}

	public void setSpEVBarinelPos(Integer spEVBarinelPos) {
		this.spEVBarinelPos = spEVBarinelPos;
	}

	public Double getSpEVBarinelMrr() {
		return spEVBarinelMrr;
	}

	public void setSpEVBarinelMrr(Double spEVBarinelMrr) {
		this.spEVBarinelMrr = spEVBarinelMrr;
	}

	public Double getSpEVBarinelMap() {
		return spEVBarinelMap;
	}

	public void setSpEVBarinelMap(Double spEVBarinelMap) {
		this.spEVBarinelMap = spEVBarinelMap;
	}
	
	

	public Long getSpExecTime() {
		return spExecTime;
	}

	public void setSpExecTime(Long spExecTime) {
		this.spExecTime = spExecTime;
	}
